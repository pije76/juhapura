# -*- coding: utf-8 -*-
"""
Django settings for Juhapura project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (juhapura/config/settings/common.py - 3 = juhapura/)
APPS_DIR = ROOT_DIR.path('juhapura')
...
LOCAL_APPS = (
    ...
    'juhapura.scholarship.apps.ScholarshipConfig'
)
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'juhapura.contrib.sites.migrations'
}
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://postgres:c0mput3r@127.0.0.1:5432/juhapura'),
}
...
ACCOUNT_ADAPTER = 'juhapura.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'juhapura.users.adapters.SocialAccountAdapter'
